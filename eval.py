...
if __name__ == "__main__":
    ...
    parser.add_argument("-out", "--out_file", dest="out_file", default="output/predicted.out", help="output file to compare")
    parser.add_argument("-src", "--src_file", dest="src_file", default="output/test.src", help="src file")
    parser.add_argument("-tgt", "--tgt_file", dest="tgt_file", default="output/test.tgt", help="target file")
